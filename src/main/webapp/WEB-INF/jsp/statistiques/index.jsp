...
<body>
    ...
    <div class="main-content">
      ...
      <main class="page-body">
        <div class="page-heading">
          ...
          <form method="get" action="${pageContext.request.contextPath}/admin/statistiques" class="filtre-periode">
            ...
            <a class="btn btn-outline" href="${pageContext.request.contextPath}/admin/statistiques">Mois actuel</a>
          </form>
        </div>
        ...
        <div class="statistiques-grille">
          ...
          <section aria-labelledby="titre-collectes">
            ...
            <article class="card card-body indicateurs-secondaires">
              ...
              <div class="indicateur-alerte"><span>Réduction estimée (&gt; 15 %)</span><strong><fmt:formatNumber value="${tableau.collecte.reductionEstimee}" maxFractionDigits="0"/> Ar</strong></div>
            </article>
          </section>
        </div>
  ...
  <script src="${pageContext.request.contextPath}/webjars/chart.js/4.4.1/dist/chart.umd.js"></script>
  <script src="${pageContext.request.contextPath}/assets/js/statistiques-graphiques.js"></script>
</body>
</html>
